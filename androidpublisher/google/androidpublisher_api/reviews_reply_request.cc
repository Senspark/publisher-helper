...
ReviewsReplyRequest* ReviewsReplyRequest::New() {
  return new client::JsonCppCapsule<ReviewsReplyRequest>;
}

// Standard immutable constructor.
ReviewsReplyRequest::ReviewsReplyRequest(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ReviewsReplyRequest::ReviewsReplyRequest(Json::Value* storage)
  : client::JsonCppData(storage) {
}
