...
InappproductsUpdateRequest* InappproductsUpdateRequest::New() {
  return new client::JsonCppCapsule<InappproductsUpdateRequest>;
}

// Standard immutable constructor.
InappproductsUpdateRequest::InappproductsUpdateRequest(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
InappproductsUpdateRequest::InappproductsUpdateRequest(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const InAppProduct InappproductsUpdateRequest::get_inappproduct() const {
   const Json::Value& storage = Storage("inappproduct");
   return client::JsonValueToCppValueHelper<InAppProduct >(storage);
}

InAppProduct InappproductsUpdateRequest::mutable_inappproduct() {
