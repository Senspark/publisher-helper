...
InappproductsListResponse* InappproductsListResponse::New() {
  return new client::JsonCppCapsule<InappproductsListResponse>;
}

// Standard immutable constructor.
InappproductsListResponse::InappproductsListResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
InappproductsListResponse::InappproductsListResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
