...
ExpansionFile* ExpansionFile::New() {
  return new client::JsonCppCapsule<ExpansionFile>;
}

// Standard immutable constructor.
ExpansionFile::ExpansionFile(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ExpansionFile::ExpansionFile(Json::Value* storage)
  : client::JsonCppData(storage) {
}
