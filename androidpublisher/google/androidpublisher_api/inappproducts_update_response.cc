...
InappproductsUpdateResponse* InappproductsUpdateResponse::New() {
  return new client::JsonCppCapsule<InappproductsUpdateResponse>;
}

// Standard immutable constructor.
InappproductsUpdateResponse::InappproductsUpdateResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
InappproductsUpdateResponse::InappproductsUpdateResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const InAppProduct InappproductsUpdateResponse::get_inappproduct() const {
   const Json::Value& storage = Storage("inappproduct");
   return client::JsonValueToCppValueHelper<InAppProduct >(storage);
}

InAppProduct InappproductsUpdateResponse::mutable_inappproduct() {
