...
DeobfuscationFilesUploadResponse* DeobfuscationFilesUploadResponse::New() {
  return new client::JsonCppCapsule<DeobfuscationFilesUploadResponse>;
}

// Standard immutable constructor.
DeobfuscationFilesUploadResponse::DeobfuscationFilesUploadResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
DeobfuscationFilesUploadResponse::DeobfuscationFilesUploadResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
