...
AppDetails* AppDetails::New() {
  return new client::JsonCppCapsule<AppDetails>;
}

// Standard immutable constructor.
AppDetails::AppDetails(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
AppDetails::AppDetails(Json::Value* storage)
  : client::JsonCppData(storage) {
}
