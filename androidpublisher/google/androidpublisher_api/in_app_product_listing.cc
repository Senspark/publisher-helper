...
InAppProductListing* InAppProductListing::New() {
  return new client::JsonCppCapsule<InAppProductListing>;
}

// Standard immutable constructor.
InAppProductListing::InAppProductListing(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
InAppProductListing::InAppProductListing(Json::Value* storage)
  : client::JsonCppData(storage) {
}
