...
ApkListingsListResponse* ApkListingsListResponse::New() {
  return new client::JsonCppCapsule<ApkListingsListResponse>;
}

// Standard immutable constructor.
ApkListingsListResponse::ApkListingsListResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ApkListingsListResponse::ApkListingsListResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
