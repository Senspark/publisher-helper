...
//     C++: 0.1.4
#ifndef  GOOGLE_ANDROIDPUBLISHER_API_IN_APP_PRODUCT_LISTING_H_
#define  GOOGLE_ANDROIDPUBLISHER_API_IN_APP_PRODUCT_LISTING_H_
 ...
 * @ingroup DataObject
 */
class InAppProductListing : public client::JsonCppData {
 public:
  /**
   ...
   */
  static InAppProductListing* New();
   ...
   */
  explicit InAppProductListing(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InAppProductListing(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~InAppProductListing();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_androidpublisher_api::InAppProductListing</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_androidpublisher_api::InAppProductListing");
  }
 ...
 private:
  void operator=(const InAppProductListing&);
};  // InAppProductListing
}  // namespace google_androidpublisher_api
#endif  // GOOGLE_ANDROIDPUBLISHER_API_IN_APP_PRODUCT_LISTING_H_
