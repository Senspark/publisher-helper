...
//     C++: 0.1.4
#ifndef  GOOGLE_ANDROIDPUBLISHER_API_INAPPPRODUCTS_LIST_RESPONSE_H_
#define  GOOGLE_ANDROIDPUBLISHER_API_INAPPPRODUCTS_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class InappproductsListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static InappproductsListResponse* New();
   ...
   */
  explicit InappproductsListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InappproductsListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~InappproductsListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_androidpublisher_api::InappproductsListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_androidpublisher_api::InappproductsListResponse");
  }
   ...
   */
  const client::JsonCppArray<InAppProduct > get_inappproduct() const;
   ...
   */
  client::JsonCppArray<InAppProduct > mutable_inappproduct();
 ...
 private:
  void operator=(const InappproductsListResponse&);
};  // InappproductsListResponse
}  // namespace google_androidpublisher_api
#endif  // GOOGLE_ANDROIDPUBLISHER_API_INAPPPRODUCTS_LIST_RESPONSE_H_
