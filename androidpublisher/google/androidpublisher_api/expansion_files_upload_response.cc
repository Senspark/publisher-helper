...
ExpansionFilesUploadResponse* ExpansionFilesUploadResponse::New() {
  return new client::JsonCppCapsule<ExpansionFilesUploadResponse>;
}

// Standard immutable constructor.
ExpansionFilesUploadResponse::ExpansionFilesUploadResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ExpansionFilesUploadResponse::ExpansionFilesUploadResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
