...
InappproductsBatchRequest* InappproductsBatchRequest::New() {
  return new client::JsonCppCapsule<InappproductsBatchRequest>;
}

// Standard immutable constructor.
InappproductsBatchRequest::InappproductsBatchRequest(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
InappproductsBatchRequest::InappproductsBatchRequest(Json::Value* storage)
  : client::JsonCppData(storage) {
}
