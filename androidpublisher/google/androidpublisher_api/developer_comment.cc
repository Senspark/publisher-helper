...
DeveloperComment* DeveloperComment::New() {
  return new client::JsonCppCapsule<DeveloperComment>;
}

// Standard immutable constructor.
DeveloperComment::DeveloperComment(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
DeveloperComment::DeveloperComment(Json::Value* storage)
  : client::JsonCppData(storage) {
}
