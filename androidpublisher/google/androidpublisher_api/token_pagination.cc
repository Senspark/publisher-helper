...
TokenPagination* TokenPagination::New() {
  return new client::JsonCppCapsule<TokenPagination>;
}

// Standard immutable constructor.
TokenPagination::TokenPagination(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
TokenPagination::TokenPagination(Json::Value* storage)
  : client::JsonCppData(storage) {
}
