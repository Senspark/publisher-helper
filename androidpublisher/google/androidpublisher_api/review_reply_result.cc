...
ReviewReplyResult* ReviewReplyResult::New() {
  return new client::JsonCppCapsule<ReviewReplyResult>;
}

// Standard immutable constructor.
ReviewReplyResult::ReviewReplyResult(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ReviewReplyResult::ReviewReplyResult(Json::Value* storage)
  : client::JsonCppData(storage) {
}
