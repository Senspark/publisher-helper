...
ApksAddExternallyHostedResponse* ApksAddExternallyHostedResponse::New() {
  return new client::JsonCppCapsule<ApksAddExternallyHostedResponse>;
}

// Standard immutable constructor.
ApksAddExternallyHostedResponse::ApksAddExternallyHostedResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ApksAddExternallyHostedResponse::ApksAddExternallyHostedResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
