...
ImagesUploadResponse* ImagesUploadResponse::New() {
  return new client::JsonCppCapsule<ImagesUploadResponse>;
}

// Standard immutable constructor.
ImagesUploadResponse::ImagesUploadResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ImagesUploadResponse::ImagesUploadResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
