...
InappproductsInsertRequest* InappproductsInsertRequest::New() {
  return new client::JsonCppCapsule<InappproductsInsertRequest>;
}

// Standard immutable constructor.
InappproductsInsertRequest::InappproductsInsertRequest(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
InappproductsInsertRequest::InappproductsInsertRequest(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const InAppProduct InappproductsInsertRequest::get_inappproduct() const {
   const Json::Value& storage = Storage("inappproduct");
   return client::JsonValueToCppValueHelper<InAppProduct >(storage);
}

InAppProduct InappproductsInsertRequest::mutable_inappproduct() {
