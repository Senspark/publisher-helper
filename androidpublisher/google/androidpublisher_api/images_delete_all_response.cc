...
ImagesDeleteAllResponse* ImagesDeleteAllResponse::New() {
  return new client::JsonCppCapsule<ImagesDeleteAllResponse>;
}

// Standard immutable constructor.
ImagesDeleteAllResponse::ImagesDeleteAllResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ImagesDeleteAllResponse::ImagesDeleteAllResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
