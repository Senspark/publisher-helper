...
ApksAddExternallyHostedRequest* ApksAddExternallyHostedRequest::New() {
  return new client::JsonCppCapsule<ApksAddExternallyHostedRequest>;
}

// Standard immutable constructor.
ApksAddExternallyHostedRequest::ApksAddExternallyHostedRequest(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ApksAddExternallyHostedRequest::ApksAddExternallyHostedRequest(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const ExternallyHostedApk ApksAddExternallyHostedRequest::get_externally_hosted_apk() const {
   const Json::Value& storage = Storage("externallyHostedApk");
   return client::JsonValueToCppValueHelper<ExternallyHostedApk >(storage);
}

ExternallyHostedApk ApksAddExternallyHostedRequest::mutable_externallyHostedApk() {
