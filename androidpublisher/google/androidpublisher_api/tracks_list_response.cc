...
TracksListResponse* TracksListResponse::New() {
  return new client::JsonCppCapsule<TracksListResponse>;
}

// Standard immutable constructor.
TracksListResponse::TracksListResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
TracksListResponse::TracksListResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
