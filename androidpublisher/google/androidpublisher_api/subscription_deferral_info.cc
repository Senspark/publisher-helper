...
SubscriptionDeferralInfo* SubscriptionDeferralInfo::New() {
  return new client::JsonCppCapsule<SubscriptionDeferralInfo>;
}

// Standard immutable constructor.
SubscriptionDeferralInfo::SubscriptionDeferralInfo(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
SubscriptionDeferralInfo::SubscriptionDeferralInfo(Json::Value* storage)
  : client::JsonCppData(storage) {
}
