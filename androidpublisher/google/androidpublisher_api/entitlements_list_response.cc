...
EntitlementsListResponse* EntitlementsListResponse::New() {
  return new client::JsonCppCapsule<EntitlementsListResponse>;
}

// Standard immutable constructor.
EntitlementsListResponse::EntitlementsListResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
EntitlementsListResponse::EntitlementsListResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
